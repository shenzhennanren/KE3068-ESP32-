...
ESP32开发板它带有内置的Wi-Fi（2.4G）和bluetooth（4.2）功能，可以轻松连接到Wi-Fi网络并与网络中的其他设备进行通信，您可以使用ESP32在浏览器中显示网页，此时网页显示 “Hello, Keyes!”。

![img](../media/cou111.png)

#### 6.5.1.2 工作原理

ESP32 最有用的功能之一是它不仅能够连接到现有的 WiFi 网络并充当 Web 服务器，还可以创建自己的网络，允许其他设备直接连接到它并访问网页。这是因为ESP32可以在三种模式下运行：Station（STA）模式、Soft Access Point（AP）模式 和 Station+AP 共存模式。
...
代码文件在`Mixly_代码`文件夹中，代码文件为`6_5_1_WiFi-HTML-String.mix`，如下图所示：

![Img](../media/acouj-017.png)
...
![Img](../media/WiFi-0.png)

输入WiFi名称和密码，连接WiFi热点。

![Img](../media/mixly-WiFi-1.png)

读取WiFi的IP地址。

![Img](../media/mixly-WiFi-2.png)

WiFi初始化客户端。

![Img](../media/mixly-WiFi-3.png)

WiFi没有连接客户端。

![Img](../media/mixly-WiFi-4.png)

WiFi发送数据。

![Img](../media/mixly-WiFi-5.png)

WiFi读取数据。

![Img](../media/mixly-WiFi-6.png)

⑤ 这是一些关于网页编辑PRO代码块。

![Img](../media/mixly-weab-editing0.png)

更新组件，其组件标签、组件单位、组件类型、组件ID和值一一对应。

![Img](../media/mixly-weab-editing1.png)

显示部件包括：温度、湿度、气压、电量、进度条、标签。
...
![Img](../media/mixly-weab-editing2.png)

更新图表表头，其组件类型、条形、组件ID、数据源和数据源Y一一对应。

![Img](../media/mixly-weab-editing3.png)

更新组件，其组件标签、组件类型、组件ID和值一一对应。

![Img](../media/mixly-weab-editing4.png)

获取组件值，其组件标签、组件类型和组件ID一一对应。

![Img](../media/mixly-web-editing3.png)

![Img](../media/web-editing3-1.png)

获取摇杆值，其组件标签、组件类型、组件ID和返回x,y一一对应。

![Img](../media/mixly-weab-editing6.png)

设置网页标题。

![Img](../media/mixly-weab-editing7.png)

设置访问用户名和密码。

![Img](../media/mixly-weab-editing8.png)

添加页面和页面ID。

![Img](../media/mixly-weab-editing9.png)

添加统计信息，其统计标签、值和ID一一对应。

![Img](../media/mixly-weab-editing10.png)

设置组件页面，其组件类型、组件ID和页面ID一一对应。

![Img](../media/mixly-weab-editing11.png)

**组合代码块**

![Img](../media/Mixly-code16.png)
